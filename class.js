class Snail {
  ...
  render () {
    ...
    this.element.className = 'snail_racer';
    ...
    <div class="snail-racer__name">Gaby</div>
    `)
    // this.change ();
    ...
    snailShell.style.fill = this.color;
  ...
  update () {
    const snailRacer = this.element.querySelector('.snail'); 
    // const snailSpeed = this.speed;
    //let position = 0;
    // let snailRun = setInterval(myTimer, 1000);

       // const snailRacer = this.element.querySelector('.snail-racer'); 
        // let snailSpeed = this.speed;
        ...
        function myTimer() {
          if (position === 1000 + 'px') {
            ...
            snailRacer.style.marginLeft = this.position + this.speed + "px";
            console.log(snailRacer.style.marginLeft);
            // this.position = snailRacer.style.a
